...
function program1(depth0,data) {
  ...
  hashContexts = {'cancelRoute': depth0};
  hashTypes = {'cancelRoute': "STRING"};
  stack1 = helpers.view.call(depth0, "App.ModalView", {hash:{
    'cancelRoute': ("list.index")
...
Ember.TEMPLATES["list/index"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program6(depth0,data) {
  ...
  data.buffer.push("<h2><span class='total'>");
  hashTypes = {};
  hashContexts = {};
